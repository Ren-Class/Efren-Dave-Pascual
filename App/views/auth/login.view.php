...
<section class="container mx-auto px-4">
    <div class="bg-white auth-card rounded-lg shadow-md">
        ...
        <p class="text-center text-gray-500 mb-6">Sign in to manage postings on JoobTech</p>
        ...
        <p class="text-center text-xs text-gray-500 mt-4">Demo: demo@joobtech.com / password123</p>
    </div>
</section>
