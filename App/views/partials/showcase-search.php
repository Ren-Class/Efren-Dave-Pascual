<section class="showcase relative flex items-center">
    ...
    <div class="container mx-auto z-10 relative pt-14 pb-12 px-4">
        <div class="showcase-content text-center max-w-3xl mx-auto">
            <p class="showcase-eyebrow">Philippines tech careers</p>
            <h2 class="showcase-title">Your Next Career Starts Here</h2>
            <p class="showcase-subtitle">Discover curated roles from startups and enterprise teams on JoobTech</p>
        </div>
