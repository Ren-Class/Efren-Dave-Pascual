...
class AuthController
{
    ...
    public function loginForm()
    {
        ...
        loadView('auth/login', ['pageTitle' => 'Login — JoobTech', 'errors' => []]);
    }
    ...
    public function registerForm()
    {
        ...
        loadView('auth/register', ['pageTitle' => 'Register — JoobTech', 'errors' => []]);
    }
    ...
    public function register()
    {
        ...
        setFlash('success_message', 'Account created successfully. Welcome to JoobTech!');
        redirect('/');
    }
