...
class ListingController
{
    ...
    public function index()
    {
        ...
        loadView('listings/index', [
            'pageTitle' => 'Browse Jobs — JoobTech',
            'listings' => $listings,
            'keywords' => $keywords,
            'location' => $location,
            'category' => $category,
    ...
    public function create()
    {
        ...
        loadView('listings/create', [
            'pageTitle' => 'Post a Position — JoobTech',
            'listing' => [],
        ]);
    }
    ...
    public function show($params)
    {
        ...
        loadView('listings/show', [
            'pageTitle' => e($listing->title) . ' — JoobTech',
            'listing' => $listing,
    ...
    public function store()
    {
        ...
        setFlash('success_message', 'Your job posting is now live on JoobTech.');
        redirect('/listings');
    }
    ...
    public function edit($params)
    {
        ...
        loadView('listings/edit', [
            'pageTitle' => 'Edit Position — JoobTech',
            'listing' => $listing,
        ]);
    }
    ...
    public function destroyForm($params)
    {
        ...
        loadView('listings/delete', [
            'pageTitle' => 'Confirm Delete — JoobTech',
            'listing' => $listing,
            'errors' => [],
        ]);
    }
